// 实现 add delete has clear forEach
// ES5版
(function (global) {
  // 为了处理用户向Set中添加NaN
  var NaNSymbol = Symbol("NaN");
  var encodeVal = function (value) {
    return value !== value ? NaNSymbol : value; // 基于：NaN === NaN //false
  };
  var decodeVal = function (value) {
    return val === NaNSymbol ? NaN : value;
  };

  var makeIterator = function (array, iterator) {
    var nextIndex = 0;

    // new Set(new Set())  会调这里
    var obj = {
      next: function () {
  ...
  Set.prototype.delete = function (value) {
    ...
    this._values.splice(idx, 1); // 从idx开始，删除1个
    --this.size;
    return true;
  };
